package com.prayagrajsharma.linkedInProject.notificationService.consumer;
...
import com.prayagrajsharma.linkedInProject.postsService.event.PostLiked;
import com.prayagrajsharma.linkedInProject.notificationService.service.NotificationService;
...
public class PostsConsumer {
    ...
    public void handlePostCreated(PostCreated postCreated) {
        ...
        String message = String.format("Your connection with id: %d has created a post: %s",
    ...
    public void handlePostLiked(PostLiked postLiked) {
        ...
        String message = String.format("Your connection with id: %d has liked your post: %d",
